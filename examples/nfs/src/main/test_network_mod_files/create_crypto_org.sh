...
# this code is originally from https://github.com/hyperledger/fabric-samples/tree/2.2.0/test-network/network.sh
...
function createConsortium() {
  ...
  set -x
  configtxgen -profile SystemChannel -channelID system-channel -outputBlock ./system-genesis-block/genesis.block
  res=$?
  { set +x; } 2>/dev/null
  if [ $res -ne 0 ]; then
