 ...
 * of a stream  for stateful value transformation).
 * If {@code ValueMapper} is applied to a record the record's
 * key is preserved.
 * If a record's key and value should be modified = can be used.
 *
 * @param <V>  value type
